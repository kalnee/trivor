...
`GET /insights/:imdbId?subtitleId=:subtitleId:`
...
- rate-of-speech: `String` Values: SLOW, MODERATE, FAST, SUPER_FAST
...
To optimize the insights application for production, run:
